...
public class MiniTester {
  ...
  void BlockConstructorTest2()
    ...
    assertEquals(expectedColor,
                 actualColor); // checking if the colors at level 1 are correct

    Block[] ulChildren = (Block[])childrenField.get(children[1]);

    assertEquals(4, ulChildren.length);

    List<Color> expectedColorUL = List.of(GameColors.GREEN, GameColors.RED,
                                          GameColors.GREEN, GameColors.RED);
    ...
    assertEquals(expectedColorUL,
                 actualColorUL); // checking if the colors at level 2 are
                                 // correct for the upper left child
  }

  @Test
  @Tag("score:3")
  @DisplayName("Block updateSizeAndPosition() test1")
  void UpdateSizeAndPositionTest1()
      throws NoSuchFieldException, IllegalAccessException {
    ...
    List<Integer> expectedCoords =
        List.of(8, 0, 0, 0, 0, 8, 8,
                8); // UL x, UL y, UR x, UR y, LL x, LL y, LR x, LR y
  ...
  void GetBlocksToDrawTest2() {
    ...
    for (BlockToDraw btd : blocksToDraw) {
      boolean frame =
          btd.getStrokeThickness() == 0 && btd.getColor() == GameColors.YELLOW;
      boolean block = btd.getStrokeThickness() == 3 &&
                      btd.getColor() == GameColors.FRAME_COLOR;
  ...
  void getSelectedBlock1() {
    ...
    assertThrows(IllegalArgumentException.class,
                 () -> b.getSelectedBlock(2, 15, 4));
    assertThrows(IllegalArgumentException.class,
                 () -> b.getSelectedBlock(15, 2, -1));
  }
  ...
  void getSelectedBlock3() throws NoSuchFieldException, IllegalAccessException {
    ...
    List<Color> colors = List.of(GameColors.BLUE, GameColors.YELLOW,
  ...
  void reflect2() throws NoSuchFieldException, IllegalAccessException {
    ...
    List<Color> expected = List.of(GameColors.BLUE, GameColors.GREEN,
                                   GameColors.RED, GameColors.YELLOW);
  ...
  void rotate2() throws NoSuchFieldException, IllegalAccessException {
    ...
    List<Color> expected = List.of(GameColors.BLUE, GameColors.RED,
                                   GameColors.BLUE, GameColors.GREEN);
  ...
  void Blockflatten1() {
    ...
    Color[][] expected = new Color[][] {
        ...
        {GameColors.YELLOW, GameColors.YELLOW, GameColors.YELLOW,
         GameColors.BLUE}};
  ...
  void Blockflatten2() {
    ...
    Color[][] expected = new Color[][] {{GameColors.YELLOW, GameColors.BLUE},
  ...
  void Blockflatten3() {
    ...
    Color[][] expected = new Color[][] {
        ...
        {GameColors.BLUE, GameColors.BLUE, GameColors.RED, GameColors.RED},
        {GameColors.GREEN, GameColors.RED, GameColors.YELLOW,
         GameColors.YELLOW},
        {GameColors.GREEN, GameColors.YELLOW, GameColors.YELLOW,
         GameColors.YELLOW}};
  ...
  void BGBlobSize1() {
    ...
    Color[][] c = new Color[][] {{GameColors.YELLOW, GameColors.BLUE},
  ...
  void BGBlobSize2() {
    ...
    Color[][] c =
        new Color[][] {{GameColors.BLUE, GameColors.RED, GameColors.GREEN},
  ...
  void BGBlobSize3() {
    ...
    assertEquals(2,
                 g.undiscoveredBlobSize(1, 1, b.flatten(), new boolean[4][4]));
  }
