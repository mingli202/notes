[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/EpjDfUN-)
# Weekly Assignment 11

## Deliverables
- Complete `add(Node node, T key)`, `printPreOrder(Node node)`, `printInOrder(Node node)`, `printPostOrder(Node node)` method in `BinarySearchTree.java`. 
...
2. Import project into your IDE of choice. For example, this can be performed by opening the cloned folder (with the naming pattern `weekly-assignment-11-*`) within Intellij.
